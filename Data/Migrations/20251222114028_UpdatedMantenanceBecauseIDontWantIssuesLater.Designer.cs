...
namespace cosycommune.Data.Migrations
{
    ...
    [Migration("20251222114028_UpdatedMantenanceBecauseIDontWantIssuesLater")]
    partial class UpdatedMantenanceBecauseIDontWantIssuesLater
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cosycommune.Models.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("cosycommune.Models.Lease", b =>
                {
                    b.HasOne("cosycommune.Models.Room", "Room")
                        .WithMany("Leases")
